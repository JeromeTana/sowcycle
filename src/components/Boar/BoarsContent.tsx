...
export default function BoarsContent() {
  ...
  return (
    <>
      <DialogComponent
        ...
        dialogTriggerButton={
          <div className="fixed z-10 flex items-center gap-2 p-4 text-white rounded-full shadow cursor-pointer bg-primary bottom-12 right-4">
            <Plus size={22} />
          </div>
        }
      >
